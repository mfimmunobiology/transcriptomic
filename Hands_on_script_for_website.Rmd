---
title: "Transcriptomics and R Programming Course"
author: 
  - Viviane Schuch^[Morehouse School of Medicine, vschuch@msm.edu]
date: "29/11/2023"
output: 
...
* [R 4.2 +](https://archive.linux.duke.edu/cran/)
* [BiocManager v3.15+](https://www.bioconductor.org/install/)
...
- **This tutorial is avaliable online on github:**: [https://mfimmunobiology.github.io/transcriptomic/Hands_on.html](https://mfimmunobiology.github.io/transcriptomic/Hands_on.html)
...
2. Enter Repository URL: **https://github.com/mfimmunobiology/transcriptomic.git**
...
## R Implementation:
```{r, warning=FALSE}
deg_table <- read.table("/home/vivischuch/Documents/github_msmclass/GSE66273.top.table.tsv", header = TRUE, sep = "\t")
...
# Hands-on 2 - Microarray analysis
...
[GEO web site](https://www.ncbi.nlm.nih.gov/geo/)
...
To begin an analysis in R, one would typically start by defining the specific GSE study identifier. For example, let see the data from this  [paper](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6092567/).
...
pointLabel(ump$layout, labels = rownames(ump$layout), method="SANN", cex=1)
...
```{r}
# Loading gene sets
hallmarks <- fgsea::gmtPathways("/home/vivischuch/class3/MSM_Rclass/hallmark.genesets.v6.1.symbols.gmt") #50 gene sets
reactome <- fgsea::gmtPathways("/home/vivischuch/class3/MSM_Rclass/reactome.genesets.v6.1.symbols.gmt") #674
